...
namespace TS.EasyStockManager.Data.Migrations
{
    ...
    [Migration("20250626222850_CreateDB")]
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Barcode = "EX01",
                            CreateDate = new DateTime(2025, 6, 27, 3, 58, 49, 876, DateTimeKind.Local).AddTicks(397),
                            Price = 1m,
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.Store", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2025, 6, 27, 3, 58, 49, 875, DateTimeKind.Local).AddTicks(5971),
                            StoreCode = "EX01",
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.TransactionType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2025, 6, 27, 3, 58, 49, 856, DateTimeKind.Local).AddTicks(1941),
                            TransactionTypeName = "Stock Receipt"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2025, 6, 27, 3, 58, 49, 857, DateTimeKind.Local).AddTicks(6521),
                            TransactionTypeName = "Stock Out"
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2025, 6, 27, 3, 58, 49, 857, DateTimeKind.Local).AddTicks(6559),
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.UnitOfMeasure", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2025, 6, 27, 3, 58, 49, 859, DateTimeKind.Local).AddTicks(6745),
                            Isocode = "pc",
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2025, 6, 27, 3, 58, 49, 859, DateTimeKind.Local).AddTicks(7003),
                            Isocode = "kg",
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2025, 6, 27, 3, 58, 49, 859, DateTimeKind.Local).AddTicks(7014),
                            Isocode = "m",
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2025, 6, 27, 3, 58, 49, 875, DateTimeKind.Local).AddTicks(1270),
