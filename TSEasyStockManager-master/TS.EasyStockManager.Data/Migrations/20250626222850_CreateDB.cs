    ...
    public partial class CreateDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2025, 6, 27, 3, 58, 49, 875, DateTimeKind.Local).AddTicks(5971), "EX01", "Example Store" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 6, 27, 3, 58, 49, 856, DateTimeKind.Local).AddTicks(1941), "Stock Receipt" },
                    { 2, new DateTime(2025, 6, 27, 3, 58, 49, 857, DateTimeKind.Local).AddTicks(6521), "Stock Out" },
                    { 3, new DateTime(2025, 6, 27, 3, 58, 49, 857, DateTimeKind.Local).AddTicks(6559), "Transfer" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 6, 27, 3, 58, 49, 859, DateTimeKind.Local).AddTicks(6745), "pc", "Piece" },
                    { 2, new DateTime(2025, 6, 27, 3, 58, 49, 859, DateTimeKind.Local).AddTicks(7003), "kg", "Kilogram" },
                    { 3, new DateTime(2025, 6, 27, 3, 58, 49, 859, DateTimeKind.Local).AddTicks(7014), "m", "Meter" }
                });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "CreateDate", "Email", "Name", "Password", "Surname" },
                values: new object[] { 1, new DateTime(2025, 6, 27, 3, 58, 49, 875, DateTimeKind.Local).AddTicks(1270), "admin@admin.com", "Admin", "827ccb0eea8a706c4c34a16891f84e7b", "Admin" });

            migrationBuilder.InsertData(
                table: "Product",
                columns: new[] { "Id", "Barcode", "CategoryId", "CreateDate", "Description", "Image", "Price", "ProductName", "UnitOfMeasureId" },
                values: new object[] { 1, "EX01", null, new DateTime(2025, 6, 27, 3, 58, 49, 876, DateTimeKind.Local).AddTicks(397), null, null, 1m, "Example Product", 1 });
